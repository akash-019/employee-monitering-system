...
<form action="admin_event_collect.jsp" method="post">
<div class="main1" ><div class="divinfo">Event Information</div><br>
<br>
	<h3>Enter Event_ID to perform Modify and Remove Operation</h3>
  <br><input type="text" name="e_ID" placeholder="Enter ID">
	<br>
	<br>
	<center>
	<table>

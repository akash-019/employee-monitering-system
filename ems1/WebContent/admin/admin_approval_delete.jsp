...
<div class="pen-title">
	...
	<div class="container">
		...
		<div class="card">
			...
			<form action="admin_approval_delete.jsp" method="POST">
			
			<div class="input-container">
					<input type="number" name="TO" required="required">
					<label>TO</label>
					<div class="bar">
					</div>
				</div>
			<div class="input-container">
					<input type="number" name="FROM" required="required">
					<label>FROM</label>
					<div class="bar">
					</div>
				</div>
...
<%	
if(session.getAttribute("del_leave")!=null)
{
	if(request.getParameter("TO")!=null && request.getParameter("FROM")!=null)
	{
			...
			{		int i=0;
					...
					String query="DELETE FROM leave_table where `Emp_ID` BETWEEN '"+request.getParameter("TO")+"' AND '"+request.getParameter("FROM")+"'";
				...
				session.removeAttribute("del_leave");
